...
import com.mabbr.news.ui.categories.categore_fragment
...
class HomeActivity:AppCompatActivity() {
    ...
    val categoreFragment = categore_fragment()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        categoreFragment.onCategoryClickListener =
            object : categore_fragment.OnCategoryClickListener {
